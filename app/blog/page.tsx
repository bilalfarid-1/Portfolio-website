...
export const metadata: Metadata = {
  title: "Blog | Muhammad Bilal Farid",
  metadataBase: new URL("https://bilalfarid.dev/blog"),
  description: "Read latest stories from Muhammad Bilal Farid's Blog",
  openGraph: {
    title: "Blog | Muhammad Bilal Farid",
    url: "https://bilalfarid.dev/blog",
    description: "Read latest stories from Muhammad Bilal Farid's Blog",
  },
};
