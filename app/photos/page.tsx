...
export const metadata: Metadata = {
  title: "Photos | Muhammad Bilal Farid",
  metadataBase: new URL("https://bilalfarid.dev/photos"),
  description: "Explore photos taken by Muhammad Bilal Farid",
  openGraph: {
    title: "Photos | Muhammad Bilal Farid",
    url: "https://bilalfarid.dev/photos",
    description: "Explore photos taken by Muhammad Bilal Farid",
  },
};
