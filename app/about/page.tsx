...
export const metadata: Metadata = {
  title: "About | Muhammad Bilal Farid",
  metadataBase: new URL("https://bilalfarid.dev/about"),
  description:
    "Learn more about my skills, experience and technical background",
  openGraph: {
    title: "About | Muhammad Bilal Farid",
    url: "https://bilalfarid.dev/about",
    description:
      "Learn more about my skills, experience and technical background",
  },
};
              ...
              <div className="sticky top-10">
                {profile?.profileImage.image ? (
                  <Image
                    ...
                    placeholder={profile?.profileImage.lqip ? "blur" : "empty"}
                    blurDataURL={profile?.profileImage.lqip || undefined}
                    priority
                  />
                ) : (
                ...
                <div className="flex flex-col text-center gap-y-4">
                  <div className="flex items-center gap-x-3">
                    ...
                    >
                      View GitHub <BiLinkExternal className="text-base" />
                    </RefLink>
                    <a
