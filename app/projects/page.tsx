...
export const metadata: Metadata = {
  title: "Projects | Muhammad Bilal Farid",
  metadataBase: new URL("https://bilalfarid.dev/projects"),
  description: "Explore projects built by Muhammad Bilal Farid",
  openGraph: {
    title: "Projects | Muhammad Bilal Farid",
    url: "https://bilalfarid.dev/projects",
    description: "Explore projects built by Muhammad Bilal Farid",
  },
};
